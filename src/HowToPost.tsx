...
const HowToPost: React.FC<HowToPostPropsWithCallback> = ({
  ...
  > = {
    ...
    spiderman: {
      ...
      textBody:
        "Spiderman, created in 1962, has been swinging through the streets of New York for decades. Peter Parker, a high school student bitten by a radioactive spider, balances the challenges of life and crime-fighting. With his iconic red and blue suit, Spiderman has become one of Marvel's most beloved characters.",
    },
    xmen: {
      title: "X-Men",
    ...
    fantasticfour: {
      ...
      subheader: "Adventuring Since 1961",
      textBody:
